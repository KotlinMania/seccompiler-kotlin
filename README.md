...
This is a Kotlin Multiplatform line-by-line transliteration port of [`rust-vmm/seccompiler`](https://github.com/rust-vmm/seccompiler).

**Original Project:** This port is based on [`rust-vmm/seccompiler`](https://github.com/rust-vmm/seccompiler). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
![seccompiler architecture](https://raw.githubusercontent.com/rust-vmm/seccompiler/HEAD/docs/img/seccompiler_arch.png)
...
![filter diagram](https://raw.githubusercontent.com/rust-vmm/seccompiler/HEAD/docs/img/seccomp_filter.png)

As specified earlier, there are two ways of expressing the filters:

1. JSON (documented in [json_format.md](https://github.com/rust-vmm/seccompiler/blob/HEAD/docs/json_format.md));
...
This Kotlin port is distributed under the same Apache-2.0 license as the upstream [`rust-vmm/seccompiler`](https://github.com/rust-vmm/seccompiler). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the seccompiler authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`rust-vmm/seccompiler`](https://github.com/rust-vmm/seccompiler) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
