...
kotlin {
    ...
    swiftExport {
        moduleName = "Seccompiler"
        flattenPackage = "io.github.kotlinmania.seccompiler"
    }

    android {
        namespace = "io.github.kotlinmania.seccompiler"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "seccompiler-kotlin", version.toString())

    pom {
        name.set("seccompiler-kotlin")
        description.set("Kotlin Multiplatform port of rust-vmm/seccompiler - Provides easy-to-use seccomp-bpf jailing")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/seccompiler-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/seccompiler-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/seccompiler-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/seccompiler-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSeccompilerXCFramework",
    "assembleSeccompilerDebugXCFramework",
    "assembleSeccompilerReleaseXCFramework",
    "assembleDebugIosFatFrameworkForSeccompilerXCFramework",
    "assembleReleaseIosFatFrameworkForSeccompilerXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForSeccompilerXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForSeccompilerXCFramework",
    "assembleDebugMacosFatFrameworkForSeccompilerXCFramework",
    "assembleReleaseMacosFatFrameworkForSeccompilerXCFramework",
    "assembleDebugTvosFatFrameworkForSeccompilerXCFramework",
    "assembleReleaseTvosFatFrameworkForSeccompilerXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForSeccompilerXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForSeccompilerXCFramework",
    "assembleDebugWatchosFatFrameworkForSeccompilerXCFramework",
    "assembleReleaseWatchosFatFrameworkForSeccompilerXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForSeccompilerXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForSeccompilerXCFramework",
