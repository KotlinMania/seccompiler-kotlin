...
This file is the quick-reference operating contract for seccompiler-kotlin. The longer
...
seccompiler-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`seccompiler`](https://crates.io/crates/seccompiler). Upstream Rust is the behavioral oracle while the
